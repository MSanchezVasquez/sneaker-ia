...
import 'package:sneaker_store/features/authentication/controllers/signup/verify_email_controller.dart';
...
class VerifyEmailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      /// This approach is taken to handle scenarios where the user enters the registration proccess,
