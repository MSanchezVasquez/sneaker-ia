...
import 'package:sneaker_store/common/widgets/products/ratings/rating_indicator.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const SizedBox(height: TSizes.spaceBtwItems),
        const ReadMoreText(
          "The user interface of the app quite intuitive. I was able to navigate and make purchases seamlessly. Great job!",
          trimLines: 2,
